                    ...
                    <form method="POST" action="{{ route('admin.roles.permissions.store', $role->id) }}">
                        ...
                        <div class="row">
                            @php
                                ...
                                $ungroupedPermissions = $groupedPermissions->get('', collect());
                            @endphp
                            ...
                            @if($ungroupedPermissions->count() > 0)
                                <div class="col-md-6 mb-4">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="mb-0">
                                                <i class="fas fa-folder-open"></i> Ungrouped
                                                <small class="text-muted">({{ $ungroupedPermissions->count() }} permissions)</small>
                                            </h6>
                                        </div>
                                        <div class="card-body p-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <ul>
                                        ...
                                        <li>Use groups to organize related permissions</li>
